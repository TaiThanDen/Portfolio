        ...
        <footer className="bg-white dark:bg-gray-900 lg:grid lg:grid-cols-5">
            ...
            <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                    <div>
                        <p>
                            <span className="text-xs tracking-wide text-gray-500 dark:text-gray-400 uppercase"> Call us </span>
                ...
                <div className="mt-12 border-t border-gray-100 dark:border-gray-700 pt-12">
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <ul className="flex flex-wrap gap-4 text-xs">
                            <li>
                                <a href="#" className="text-gray-500 dark:text-gray-400 transition hover:opacity-75"> Terms & Conditions </a>
                            </li>

                            <li>
                                <a href="#" className="text-gray-500 dark:text-gray-400 transition hover:opacity-75"> Privacy Policy </a>
                            </li>

                            <li>
                                <a href="#" className="text-gray-500 dark:text-gray-400 transition hover:opacity-75"> Cookies </a>
                            </li>
                        </ul>
